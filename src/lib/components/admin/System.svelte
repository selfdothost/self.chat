<script>
    ...
    import Residency from './System/Residency.svelte';
    ...
    function poll() {
        ...
        // 'models' polls itself inside Residency, on a tighter cadence than this
        // one — fetching processes for it would be pure waste.
    }
...
<div class="flex flex-col lg:flex-row w-full h-full pb-2 lg:space-x-4">
    ...
    >
        ...
        >
            <div class="self-center mr-2">
                ...
                >
                    <path
                        d="M10 1 2 5.5 10 10l8-4.5L10 1ZM2 9.5 10 14l8-4.5M2 13.5 10 18l8-4.5"
                        fill="none"
                        stroke="currentColor"
                        stroke-width="1.5"
        ...
        <div class="lg:mt-auto lg:pt-4 lg:border-t dark:border-gray-800">
            <button
                ...
                title={$i18n.t(
                    'Force-unload every GPU model system-wide (LLM, speech, image generation)'
                )}
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="flex-1 mt-3 lg:mt-0 overflow-y-scroll pr-1 scrollbar-hidden">
        ...
        {:else if selectedTab === 'models'}
            <!-- Residency polls on its own cadence (2s while a swap is queued, vs
			     this panel's 5s): the swap gate reads in-flight slot counts, and a
			     5s window is long enough to fire a load into a request that started
			     after the last read. -->
            <Residency />
        {/if}
    </div>
